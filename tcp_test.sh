...
start_menu() {
 ...
 ${Green_font_prefix}3.${Font_color_suffix} 安装 Lotserver(锐速)内核 		 ${Green_font_prefix}4.${Font_color_suffix} 安装 BBR ARM mainline内核
 ${Green_font_prefix}5.${Font_color_suffix} 安装 BBRplus新版内核
