...
InitialEhco() {
    ...
    if [ ! -e "/usr/bin/ehco" ]; then
    	url="https://github.com/Ehco1996/ehco/releases/download/v1.1.0/ehco_1.1.0_linux_arm64"
...
ConfPy() {
	...
	*)
	...
	if [ ! -e "/usr/local/ehco/ehcoConfigure_beta01.py" ]; then
		...
		wget -O /usr/local/ehco/ehcoConfigure_beta01.py "https://raw.githubusercontent.com/Joseph-ink/Useful-tools/main/ehcoConfigure.py" &> null
	fi
