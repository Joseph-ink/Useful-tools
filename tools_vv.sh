...
${Green_font_prefix}2.${Font_color_suffix} TCP窗口调优(原版内核 bbr+fq)
${Green_font_prefix}3.${Font_color_suffix} TCP窗口调优(XANMOD bbr+fq_pie)
${Green_font_prefix}4.${Font_color_suffix} TCP窗口调优(XANMOD bbr2+fq_pie)
${Green_font_prefix}5.${Font_color_suffix} TCP窗口调优(BBRPLUS bbrplus+fq)
${Green_font_prefix}6.${Font_color_suffix} 开启内核转发
${Green_font_prefix}7.${Font_color_suffix} 系统资源限制调优
${Green_font_prefix}8.${Font_color_suffix} 屏蔽ICMP
${Green_font_prefix}9.${Font_color_suffix} 开放ICMP
"
get_system_info
